...
<script src="{{ env('S3_URL_VIEW') }}{{ ('assets/global/plugins/jquery-slimscroll/jquery.slimscroll.min.js') }}" type="text/javascript"></script>
...
<script src="{{ env('S3_URL_VIEW') }}{{ ('assets/layouts/layout/scripts/layout.min.js') }}" type="text/javascript"></script>
