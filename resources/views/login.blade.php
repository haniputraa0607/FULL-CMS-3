...
<html lang="en">
    ...
    <head>
		...
		<meta property="og:image" content="{{url('images/logo_face_200.png')}}" />
		<meta property="og:image:width" content="200" />
		<meta property="og:image:height" content="200" />
		<link href="{{url('images/logo_face_200.png')}}" rel="image_src" />
		<meta name="apple-mobile-web-app-capable" content="yes">
		<link rel="shortcut icon" sizes="200x200" href="{{url('images/logo_face_200.png')}}">
