...
<html lang="en">
    ...
    <head>
		...
		<meta property="og:image" content="{{Cdn::asset('kk-ass/images/logo_face_200.png')}}" />
		<meta property="og:image:width" content="200" />
		<meta property="og:image:height" content="200" />
		<link href="{{Cdn::asset('kk-ass/images/logo_face_200.png')}}" rel="image_src" />
		<meta name="apple-mobile-web-app-capable" content="yes">
		<link rel="shortcut icon" sizes="200x200" href="{{Cdn::asset('kk-ass/images/logo_face_200.png')}}">
        ...
        <link href="{{Cdn::asset('kk-ass/assets/pages/css/login.min.css')}}" rel="stylesheet" type="text/css" />
        <!-- END PAGE LEVEL STYLES -->
        <!-- BEGIN THEME LAYOUT STYLES -->
        <!-- END THEME LAYOUT STYLES -->
		<link rel="shortcut icon" href="{{Cdn::asset('kk-ass/images/favicon-behave.ico')}}" />
    ...
    <body class=" login">
        ...
        <div class="logo">
            <a href="index.html">
                <img src="{{Cdn::asset('kk-ass/images/logo_kk.png?')}}'" alt="" style="width:250px" /> </a>
        </div>
        <!-- END LOGO -->
        <!-- BEGIN LOGIN -->
        <div class="content">
...
<![endif]-->
        ...
        <script src="{{Cdn::asset('kk-ass/assets/global/plugins/jquery-slimscroll/jquery.slimscroll.min.js')}}" type="text/javascript"></script>
        ...
        <!-- END CORE PLUGINS -->
        <!-- BEGIN PAGE LEVEL PLUGINS -->
        <script src="{{Cdn::asset('kk-ass/assets/global/plugins/jquery-validation/js/jquery.validate.min.js')}}" type="text/javascript"></script>
        <script src="{{Cdn::asset('kk-ass/assets/global/plugins/jquery-validation/js/additional-methods.min.js')}}" type="text/javascript"></script>
        ...
        <script src="{{Cdn::asset('kk-ass/assets/pages/scripts/login.min.js')}}" type="text/javascript"></script>
