...
<a href="{{url('campaign/push/outbox')}}" class="btn blue" style="margin-left:15px;margin-bottom:20px">< Back</a><br>
	<div class="col-md-12">
		<div class="portlet light bordered">
			<div class="portlet-title">
				<div class="caption font-blue ">
					<i class="icon-settings font-blue "></i>
					<span class="caption-subject bold uppercase">Campaign Push Notification Outbox Detail</span>
				</div>
			</div>
			<div class="portlet-body form">
				<div class="form-body">
					<div class="form-group">
						...
						<input type="text" class="form-control" value="{{$result['push_sent_to']}}" readonly>
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						<label>Message</label>
						<div style="background-color: #eef1f5;width:100%;padding-left:15px;padding-top:10px;padding-bottom:5px"><?php echo $result['push_sent_content'];?></div>
					</div>
				</div>
			</div>
		</div>
