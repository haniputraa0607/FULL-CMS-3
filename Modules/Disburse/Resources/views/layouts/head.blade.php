<head>
        ...
        <link href="{{ env('S3_URL_VIEW') }}{{ ('assets/global/plugins/pace/themes/pace-theme-flash.css?') }}" rel="stylesheet" type="text/css" />
        <!-- END PAGE TOP STYLES -->
        ...
        <link href="{{ env('S3_URL_VIEW') }}{{ ('assets/layouts/layout/css/layout.min.css') }}" rel="stylesheet" type="text/css" />
        <link href="{{ env('S3_URL_VIEW') }}{{ ('assets/layouts/layout/css/themes/light.min.css') }}" rel="stylesheet" type="text/css" id="style_color" />
        <link href="{{ env('S3_URL_VIEW') }}{{ ('assets/layouts/layout/css/custom.min.css') }}" rel="stylesheet" type="text/css" />
