...
<html lang="en">
    <head>
        ...
        <link href="{{asset('kopikenangan-view-asset/public/css/slide.css') }}" rel="stylesheet">
        <style type="text/css">
        @font-face {
            font-family: 'Seravek';
            font-style: normal;
            font-weight: 400;
            src: url('{{asset("assets/fonts/Seravek.ttf?")}}') format('truetype'); 
        }
        ...
        @font-face {
            ...
            font-style: normal;
            font-weight: 400;
            src: url('{{asset("assets/fonts/Seravek-Light.ttf?")}}') format('truetype'); 
        }
        ...
        @font-face {
            ...
            font-style: normal;
            font-weight: 400;
            src: url('{{asset("assets/fonts/Seravek-Medium.ttf?")}}') format('truetype'); 
        }
        ...
        @font-face {
            ...
            font-style: normal;
            font-weight: 400;
            src: url('{{asset("assets/fonts/Seravek-Italic.ttf?")}}') format('truetype'); 
        }
        ...
        @font-face {
            ...
            font-style: normal;
            font-weight: 400;
            src: url('{{asset("kopikenangan-view-asset/public/assets/fonts/Roboto-Regular.ttf?")}}') format('truetype'); 
        }
        .kotak1 {
            padding-top: 10px;
            padding-bottom: 10px;
