...
<div class="switcher" data-current-step="-1">
	...
	<div class="switcher-item" data-step="1">
		<div class="portlet light bordered">
			...
			<div class="portlet-body form">
				<form class="form-horizontal" role="form" action="{{ url('product-variant/export') }}" method="post">
					<div class="form-body">
	...
	<div class="switcher-item" data-step="2">
		<div class="portlet light bordered">
			...
			<div class="portlet-body form upload-container">
				<div id="upload-form">
					<form class="form-horizontal" role="form" action="{{ url('product-variant/import/save') }}" method="post" enctype="multipart/form-data" id="form-upload">
						<div class="form-body">
							<div class="form-group text-center">
					...
					<div class="form-actions" style="padding-bottom: 5px">
						...
						<div class="row">
							<div class="col-md-offset-4 col-md-4 text-center">
								...
								<a href="{{url('product-variant-group/import')}}" class="btn green btn-wizard" >Next<i class="fa fa-arrow-right"></i></a>
							</div>
						</div>
					</div>
				</form>
