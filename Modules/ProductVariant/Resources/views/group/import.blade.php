	...
	<div class="switcher" data-current-step="-1">
			...
			<div class="portlet light bordered">
				...
				<div class="portlet-body form">
					<div class="m-heading-1 border-green m-bordered">
						<p style="white-space: pre-wrap;">Menu ini digunakan untuk melakukan impor atau ekspor data produk variant group.</p>
						<p style="white-space: pre-wrap;">Saat melakukan impor produk variant group, mohon diperhatikan bahwa : </p>
						<ul>
		...
		<div class="switcher-item" data-step="1">
			<div class="portlet light bordered">
				<div class="portlet-title">
					<div class="caption">
						<span class="caption-subject font-dark sbold uppercase font-green">Download Template Product Variant Group</span>
					</div>
				</div>
				<div class="portlet-body form">
		...
		<div class="switcher-item" data-step="2">
			<div class="portlet light bordered">
				<div class="portlet-title">
					<div class="caption">
						<span class="caption-subject font-dark sbold uppercase font-green">Upload Data Product Variant Group</span>
					</div>
				</div>
				<div class="portlet-body form upload-container">
					<div id="upload-form">
						<form class="form-horizontal" role="form" action="{{ url('product-variant-group/import/save') }}" method="post" enctype="multipart/form-data" id="form-upload">
							<div class="form-body">
								<div class="form-group text-center">
		...
		<div class="switcher-item" data-step="3">
			<div class="portlet light bordered">
				<div class="portlet-title">
					<div class="caption">
						<span class="caption-subject font-dark sbold uppercase font-green">Import Result Product Variant Group</span>
					</div>
				</div>
