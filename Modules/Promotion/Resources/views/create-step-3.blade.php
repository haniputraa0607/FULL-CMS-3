...
@section('page-style')
	...
	<link href="{{Cdn::asset('kk-ass/public/assets/pages/css/profile.min.css') }}" rel="stylesheet" type="text/css" /> 
...
@section('page-plugin')
	...
	<script src="{{Cdn::asset('kk-ass/public/assets/global/plugins/bootstrap-timepicker/js/bootstrap-timepicker.min.js') }}" type="text/javascript"></script>
    ...
    <script src="{{Cdn::asset('kk-ass/public/assets/global/plugins/jquery.input-ip-address-control-1.0.min.js') }}" type="text/javascript"></script>
