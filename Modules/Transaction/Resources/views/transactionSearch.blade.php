...
@section('content')
    ...
    <form role="form" action="{{ url('transaction/filter') }}" method="post">
    ...
    @if (!empty($search))
	    <div class="alert alert-block alert-info fade in">
			...
			<h4 class="alert-heading">Displaying search result :</h4>
				<p>{{ $count }}</p><br>
        <a href="{{ url('transaction/search') }}" class="btn btn-sm btn-warning">Reset</a>
			<br>
		</div>
    @endif
                    ...
                    @foreach($list as $res)
                        <tr>
                            ...
                            <td>
                                ...
                                <a class="btn btn-block red btn-xs" href="#" data-toggle="confirmation" data-placement="top"><i class="icon-close"></i> Delete </a>
                            </td>
                        </tr>
                    @endforeach
                @endif
