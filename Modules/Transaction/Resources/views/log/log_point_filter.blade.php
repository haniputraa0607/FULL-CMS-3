<script>
	...
	function changeSubject(val){
		...
		if(subject_value == 'point' || subject_value == 'grand_total' || subject_value == 'point_conversion' || subject_value == 'membership_point_percentage'){
			var operator = "conditions["+index+"][operator]";
			var operator_value = document.getElementsByName(operator)[0];
			for(i = operator_value.options.length - 1 ; i >= 0 ; i--) operator_value.remove(i);
			operator_value.options[operator_value.options.length] = new Option('=', '=');
									...
									<div class="col-md-12">
										...
										<div class="col-md-4">
											<select name="subject" class="form-control input-sm select2" placeholder="Search Subject" onChange="changeSubject(this.name)" style="width:100%">
												...
												<option value="point" @if ($con['subject'] == 'point') selected @endif>Point</option>
												...
												<option value="point_conversion" @if ($con['subject'] == 'point_conversion') selected @endif>Point Convers</option>
												<option value="membership_level" @if ($con['subject'] == 'membership_level') selected @endif>Membership</option>
												<option value="membership_point_percentage" @if ($con['subject'] == 'membership_point_percentage') selected @endif>Point Percentage</option>
											</select>
										</div>
										<div class="col-md-4">
