<script>
	...
	function changeSubject(val){
		...
		if(subject_value == 'receipt' || subject_value == 'name' || subject_value == 'phone' || subject_value == 'email' || subject_value == 'confirm_by' ){
		...
		if(subject_value == 'grand_total' || subject_value == 'payment_nominal' 
			|| subject_value == 'confirmed_at' || subject_value == 'cancelled_at' ){
			var operator = "conditions["+index+"][operator]";
			var operator_value = document.getElementsByName(operator)[0];
			for(i = operator_value.options.length - 1 ; i >= 0 ; i--) operator_value.remove(i);
			operator_value.options[operator_value.options.length] = new Option('=', '=');
								...
								<div class="mt-repeater-cell">
									<div class="col-md-12">
										...
										<select name="operator" class="form-control input-sm select2" placeholder="Search Operator" id="test" style="width:100%" required>
											...
											@elseif ($con['subject'] == 'grand_total' || $con['subject'] == 'payment_nominal' || $con['subject'] == 'confirmed_at' || $con['subject'] == 'cancelled_at' )
