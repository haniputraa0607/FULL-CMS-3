...
@section('content')
	...
	<div class="portlet light" style="padding-top: 0px;padding-bottom: 0px;">
		<div class="portlet-body row">
			<a class="btn green" data-toggle="modal" href="#new">Tambah Payment Method</a>
		</div>
	</div>
    ...
    <div class="portlet light portlet-fit bordered">
        <div class="portlet-title">
            <div class="caption">
                <span class="caption-subject font-red sbold uppercase">Payment Method List</span>
            </div>
        </div>
	...
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			...
			<div class="modal-body form ">
				<form class="form-horizontal" action="{{url('transaction/manualpayment/banks/method/create')}}" method="POST">
					{{csrf_field()}}
					<div class="form-body">
						<div class="form-group">
							<label class="col-md-3 control-label">Nama Payment Method <span class="required" aria-required="true"> * </span></label>
							<div class="col-md-9">
