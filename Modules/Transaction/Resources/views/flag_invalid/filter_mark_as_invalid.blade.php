                ...
                <div class="col-md-9" style="margin-left:2%;">
                    <div class="mt-radio-inline">
                        <label class="mt-radio">
                            <input type="radio" name="filter_type" id="optionFilterType1" value="receipt_number" checked> Receipt Number
                            <span></span>
                        </label>
                        <label class="mt-radio">
                            <input type="radio" name="filter_type" id="optionFilterType2" value="order_id"> Order ID
                            <span></span>
                        </label>
                    </div>
                </div>
