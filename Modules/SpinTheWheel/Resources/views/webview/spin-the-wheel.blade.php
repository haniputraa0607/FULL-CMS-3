...
<head>
    ...
    <link href="{{Cdn::asset('kopikenangan-view-asset/public/assets/webview/css/spin-the-wheel.css') }}" rel="stylesheet" type="text/css" /> 
...
<body>
	...
	<script src="{{Cdn::asset('kopikenangan-view-asset/public/assets/webview/scripts/winwheel.min.js') }}" type="text/javascript"></script>
	<script src="{{Cdn::asset('kopikenangan-view-asset/public/assets/webview/scripts/TweenMax.min.js') }}" type="text/javascript"></script>
