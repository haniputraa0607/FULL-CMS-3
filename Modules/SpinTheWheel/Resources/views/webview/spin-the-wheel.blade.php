...
<head>
    ...
    <link href="{{ url('assets/webview/css/spin-the-wheel.css') }}" rel="stylesheet" type="text/css" /> 
...
<body>
	...
	<script src="{{ url('assets/webview/scripts/winwheel.min.js') }}" type="text/javascript"></script>
	<script src="{{ url('assets/webview/scripts/TweenMax.min.js') }}" type="text/javascript"></script>
