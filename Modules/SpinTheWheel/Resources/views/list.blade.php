            ...
            $.ajax({
                ...
                success : function(result) {
                    if (result['status'] == "success") {
                        ...
                        toastr.warning("Failed to delete item. " + result['messages']);
                    }
                }
            });
        });
                        ...
                        @foreach($items as $key => $value)
                            <tr>
                                ...
                                <td style="width: 80px;"> 
                                    ...
                                    <a href="{{ url('/spinthewheel/edit') }}/{{ $value['id_deals'] }}" class="btn btn-sm blue"><i class="fa fa-edit"></i></a> 
                                    @endif
                                </td>
                            </tr>
                        @endforeach
