                                ...
                                <div id="contentTarget" class="sortable">
                                        ...
                                        <div id="accordion1">
                                            <div class="col-md-6 content-title">
                                                <div class="input-group">
                                                    <input type="text" class="form-control" name="content_title[]"  placeholder="Content Title" required maxlength="20" value="{{ $deals['deals_content'][0]['title']??'Ketentuan' }}">
                                            ...
                                            <div class="col-md-3">
                                                    <input type="checkbox" class="make-switch visibility-switch" {{ isset($deals['deals_content'][0]['is_active']) ? 'checked' : '' }} data-on="success" data-on-color="success" data-on-text="Visible" data-off-text="Hidden" data-size="normal" name="visible[1][]">
                                            </div>
                                            <div class="col-md-12 accordion-body collapse {{ empty($deals['deals_content'][0]['deals_content_details']) ? 'in' : '' }}" id="collapse_1">
                                                <div class="form-group mt-repeater">
                                                    <div>
                                                        <div id="contentDetail1" class="sortable-detail-1">
                                                            @if( !empty($deals['deals_content'][0]['deals_content_details']) )
                                                            @foreach( $deals['deals_content'][0]['deals_content_details'] as $key => $value )
                                    ...
                                    <div class="form-group content-count bottom-border unsortable">
                                        <div id="accordion2">
                                            <div class="col-md-6 content-title">
                                                <div class="input-group">
                                                    <input type="text" class="form-control" name="content_title[]"  placeholder="Content Title" required maxlength="20" value="{{ $deals['deals_content'][1]['title']??'Cara Pakai' }}">
                                                    <input type="hidden" name="id_deals_content[]" value="{{ $deals['deals_content'][1]['id_deals_content']??0 }}">
                                                    <input type="hidden" name="content_order[]" value="0">
                                                    <span class="input-group-addon">
                                            ...
                                            <div class="col-md-3">
                                                    <input type="checkbox" class="make-switch visibility-switch" {{ isset($deals['deals_content'][1]['is_active']) ? 'checked' : '' }} data-on="success" data-on-color="success" data-on-text="Visible" data-off-text="Hidden" data-size="normal" name="visible[2][]">
                                            </div>
                                            <div class="col-md-12 accordion-body collapse {{ empty($deals['deals_content'][1]['deals_content_details']) ? 'in' : '' }}" id="collapse_2">
                                                <div class="form-group mt-repeater">
                                                    <div>
                                                        <div id="contentDetail2" class="sortable-detail-2">
                                                            @if( !empty($deals['deals_content'][1]['deals_content_details']) )
                                                            @foreach( $deals['deals_content'][1]['deals_content_details'] as $key => $value )
                                            ...
                                            @if($key > 1)
                                                ...
                                                <div class="form-group content-count bottom-border">
                                                    <div id="accordion{{$key}}">
                                                        ...
                                                        <div class="col-md-12 accordion-body collapse {{ empty($val['deals_content_details']) ? 'in' : '' }}" id="collapse_{{$key}}">
                                                            <div class="form-group mt-repeater">
                                                                <div>
                                                                    <div id="contentDetail{{$key}}" class="sortable-detail-{{$key}}">
                                                                        @if( !empty($val['deals_content_details']) )
                                                                        @foreach( $val['deals_content_details'] as $key2 => $value2 )
