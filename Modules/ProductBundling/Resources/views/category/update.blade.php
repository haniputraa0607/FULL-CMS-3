...
@section('content')
    ...
    <div class="portlet light bordered">
        <div class="portlet-title">
            <div class="caption">
                <span class="caption-subject font-dark sbold uppercase font-blue">Update Bundling Category</span>
            </div>
        </div>
            ...
            <form class="form-horizontal" role="form" action="{{ url()->current() }}" method="post" enctype="multipart/form-data">
                ...
                <div class="form-body">
                    <div class="form-group">
                        ...
                        <div class="col-md-7">
                            <div class="input-icon right">
                                <input type="text" placeholder="Category Name" class="form-control" name="bundling_category_name" value="{{ $cat['bundling_category_name'] }}">
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                                ...
                                <optgroup label="Parent List">
                                    ...
                                    @if (!empty($parent))
                                        @foreach($parent as $suw)
                                            <option value="{{ $suw['id_bundling_category'] }}" @if ($cat['id_parent_category'] == $suw['id_bundling_category']) selected @endif>{{ $suw['bundling_category_name'] }}</option>
                                        @endforeach
                                    @endif
                                </optgroup>
                            </select>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-7">
                            <div class="input-icon right">
                                <textarea name="bundling_category_description" class="form-control summernote">{{ $cat['bundling_category_description'] }}</textarea>
                            </div>
                        </div>
                    </div>
                </div>
                <input type="hidden" name="id_bundling_category" value="{{ $cat['id_bundling_category'] }}">
                @endforeach
