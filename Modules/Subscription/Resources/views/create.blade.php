        ...
        $(document).ready(function() {
            ...
            $("input[name='voucher_type']").click(function() {
                ...
                if (nilai != "percent") {
                    ...
                    $('#voucher-percent').hide();
                    $('#discount-max').hide();
                    $("input[name='subscription_voucher_percent']").prop('required', false);
                    $('#voucher-cash').show();
                    ...
                    $('#discount-max').show();
                    $("input[name='subscription_voucher_percent']").prop('required', true);
                    $('#voucher-cash').hide();
            ...
            $("input[name='percent_max']").click(function() {
                ...
                if (nilai == "true") {
                    ...
                    $('#discount-max-value').show();
                    $('#percent-max-value').show();
                    $("input[name='subscription_voucher_percent_max']").prop('required', true);
                }
                else {

                    $('#discount-max-value').hide();
                    $('#percent-max-value').hide();
                ...
                <div class="form-body">
                    ...
                    <div class="form-group">
                        <div class="input-icon right">
                            ...
                            <span class="required" aria-required="true"> * </span>
                            <i class="fa fa-question-circle tooltips" data-original-title="Syarat dan ketentuan mengenai subscription" data-container="body"></i>
                            </label>
                        </div>
                        <div class="col-md-9">
                            <div class="input-icon right">
                                <textarea name="subscription_term" id="field_tos" class="form-control summernote" placeholder="subscription Terms and Conditions">{{ old('subscription_term') }}</textarea>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <div class="input-icon right">
                            ...
                            How To Use
                            <span class="required" aria-required="true"> * </span>
                            <i class="fa fa-question-circle tooltips" data-original-title="Penjelasan cara pemakaian subscription yang dibuat" data-container="body"></i>
                            </label>
                        </div>
                        <div class="col-md-9">
                            <div class="input-icon right">
                                <textarea name="subscription_how_to_use" id="field_content_long" class="form-control summernote" placeholder="Subscription How to Use">{{ old('subscription_how_to_use') }}</textarea>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <div class="input-icon right">
                            ...
                            Voucher Total
                            <span class="required" aria-required="true"> * </span>
                            <i class="fa fa-question-circle tooltips" data-original-title="Jumlah voucher yang dapat digunakan setelah membeli subscription. Minimal 1 voucher" data-container="body"></i>
                            </label>
                        </div>
                        ...
                        <div class="col-md-9">
                            <div class="input-icon right">
                                <div class="col-md-3">
                                    <div class="md-radio-inline">
                                        <div class="md-radio">
                                            <input type="radio" name="voucher_type" id="radio9" value="percent" class="prices md-radiobtn" required @if (old('voucher_type') == "percent") checked @endif>
                                            <label for="radio9">
                                                <span></span>
                                                <span class="check"></span>
                                ...
                                <div class="col-md-3">
                                    <div class="md-radio-inline">
                                        <div class="md-radio">
                                            <input type="radio" name="voucher_type" id="radio10" value="cash" class="prices md-radiobtn" required @if (old('voucher_type') == "cash") checked @endif>
                                            <label for="radio10">
                                                <span></span>
                                                <span class="check"></span>
                    ...
                    <div class="form-group" id="voucher-value" style="display: none;">
                        ...
                        <div class="col-md-9">
                            ...
                            <div class="col-md-9 payment" id="voucher-percent">
                            ...
                            <div class="col-md-9 payment" id="voucher-cash">
                        ...
                        <div class="col-md-9">
                            <div class="input-icon right">
                                <div class="col-md-3">
                                    <div class="md-radio-inline">
                                        <div class="md-radio">
                                            <input type="radio" name="percent_max" id="radio11" value="true" class="prices md-radiobtn" required @if (old('percent_max') == "true") checked @endif>
                                            <label for="radio11">
                                                <span></span>
                                                <span class="check"></span>
                                ...
                                <div class="col-md-3">
                                    <div class="md-radio-inline">
                                        <div class="md-radio">
                                            <input type="radio" name="percent_max" id="radio12" value="false" class="prices md-radiobtn" required @if (old('percent_max') == "false") checked @endif>
                                            <label for="radio12">
                                                <span></span>
                                                <span class="check"></span>
                    ...
                    <div class="form-group" id="discount-max-value" style="display: none;">
                        <label class="col-md-3 control-label"></label>
                        <div class="col-md-9">
                            <div class="col-md-3">
                                <label class="control-label">Nominal <span class="required" aria-required="true"> * </span> </label>
                            </div>
                            <div class="col-md-9 payment" id="percent-max-value">
