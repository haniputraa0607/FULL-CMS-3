								...
								<div id="product-rule-option">
									...
									<div class="mt-radio-list">
										<label class="mt-radio mt-radio-outline"> All items must be present
											<input type="radio" value="and" name="product_rule" @if(isset($result['product_rule']) && $result['product_rule'] === 'and' && !empty($result['promo_campaign_product_discount_rules'])) checked @endif required/>
										...
										<label class="mt-radio mt-radio-outline"> One of the items must exist
											<input type="radio" value="or" name="product_rule" @if(isset($result['product_rule']) && $result['product_rule'] === 'or' && !empty($result['promo_campaign_product_discount_rules'])) checked @endif required/>
