                        ...
                        <form id="form" class="form-horizontal" role="form" action="{{ url('achievement/create') }}" method="post" enctype="multipart/form-data">
                            <div class="form-body">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8">
						                <select id="selectCategory" data-placeholder="Select or Type new Category" name="category[name]" class="form-control select2-multiple select2-hidden-accessible">
                                            <option></option>
