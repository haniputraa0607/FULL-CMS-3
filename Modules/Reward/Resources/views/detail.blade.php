...
@section('page-script')
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            var count_winner = "{{$reward[0]['count_winner']}}"
            var winner = "{{$reward[0]['reward_total_winner']}}"
            $(".select2-multiple").select2({
                maximumSelectionLength: parseInt(count_winner) - parseInt(winner),
                width: '100%',
            });
            ...
            if ((file = this.files[0])) {
                ...
                image.onload = function() {
                    if (this.width == widthImg && this.height == heightImg) {
                        ...
                        $('#imagereward').children('img').attr('src', "{{$reward[0]['url_reward_image']}}");
                        $('#fieldphoto').val("");
...
@section('content')
    ...
    <div class="row">
        ...
        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
            <a class="dashboard-stat dashboard-stat-v2 blue">
                ...
                <div class="details">
                    <div class="number">
                        <span data-counter="counterup" data-value="{{ $reward[0]['reward_total_coupon'] }}">{{ $reward[0]['reward_total_coupon'] }}</span>
                    </div>
                    <div class="desc"> Total Coupon </div>
                </div>
            </a>
        </div>
        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
            <a class="dashboard-stat dashboard-stat-v2 green">
                ...
                <div class="details">
                    <div class="number">
                        <span data-counter="counterup" data-value="{{ $reward[0]['reward_total_user'] }}">{{ $reward[0]['reward_total_user'] }}</span>
                    </div>
    ...
    <div class="portlet light bordered">
        <div class="portlet-title tabbable-line">
            <div class="caption">
                <span class="caption-subject font-blue bold uppercase">{{ $reward[0]['reward_name'] }}</span>
            </div>
            <ul class="nav nav-tabs">
                ...
                <li>
                    <a href="#winner" data-toggle="tab"> Winner </a>
                </li>
            </ul>
        </div>
        <div class="portlet-body">
            ...
            <div class="tab-content">
                ...
                <div class="tab-pane" id="participate">
                    @include('reward::participate')
                </div>
                <div class="tab-pane" id="winner">
                    @include('reward::winner')
                </div>
            </div>
        </div>
    </div>
