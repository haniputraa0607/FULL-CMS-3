...
@section('page-script')
    ...
    <script src="{{Cdn::asset('kk-ass/public/assets/global/plugins/jquery-inputmask/jquery.inputmask.bundle.min.js') }}" type="text/javascript"></script>
    ...
    <script src="{{Cdn::asset('kk-ass/public/assets/pages/scripts/form-input-mask.min.js') }}" type="text/javascript"></script>
            ...
            <form class="form-horizontal" role="form" action="{{ url()->current() }}" method="post" enctype="multipart/form-data">
                <div class="form-body">
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                            <input type="text" class="form-control" name="membership_name" value="{{ $data['membership_name'] }}">
                        </div>
                    </div>
					<hr>
                    <h4>Requirements</h4>
					<div class="form-group">
                        ...
                        <div class="col-md-3">
                            <input type="text" class="form-control mask_number" name="min_total_value" value="{{ $data['min_total_value'] }}">
                        </div>
						<label class="col-md-3 control-label">Retain Transaction Value</label>
                        <div class="col-md-3">
                            <input type="text"  class="form-control mask_number" name="retain_min_total_value" value="{{ $data['retain_min_total_value'] }}">
                        </div>
                    </div>
					<div class="form-group">
                        <label class="col-md-3 control-label">Transaction Count</label>
                        <div class="col-md-3">
                            <input type="text"  class="form-control mask_number" name="min_total_count" value="{{ $data['min_total_count'] }}">
                        </div>
						 <label class="col-md-3 control-label">Retain Transaction Count</label>
                        <div class="col-md-3">
                            <input type="text" class="form-control mask_number" name="retain_min_total_count" value="{{ $data['retain_min_total_count'] }}">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-md-3 control-label">Retain Days</label>
                        <div class="col-md-3">
                            <input type="text" class="form-control mask_number" name="retain_days" value="{{ $data['retain_days'] }}">
                        </div>
                    </div>
					<hr>
                    <h4>Benefits</h4>
					<div class="form-group">
                        ...
                        <div class="col-md-3">
                            <input type="text" class="form-control mask_decimal" name="benefit_point_multiplier" value="{{ $data['benefit_point_multiplier'] }}" style="text-algin:left !important;">
                        </div>
						 <label class="col-md-3 control-label">Cashback Multiplier</label>
                        <div class="col-md-3">
                            <input type="text" class="form-control mask_decimal" name="benefit_cashback_multiplier" value="{{ $data['benefit_cashback_multiplier'] }}" style="text-algin:left !important;">
                        </div>
                    </div>
					<div class="form-group">
                        <label class="col-md-3 control-label">Promo ID</label>
                        <div class="col-md-3">
                            <input type="text" class="form-control" name="benefit_promo_id" value="{{ $data['benefit_promo_id'] }}">
                        </div>
						 <label class="col-md-3 control-label">Discount</label>
                        <div class="col-md-3">
                            <input type="text" class="form-control mask_number" name="benefit_discount" value="{{ $data['benefit_discount'] }}">
                        </div>
                    </div>
                </div>
