    ...
    <div class="switcher" data-current-step="-1">
        ...
        <div class="switcher-item" data-step="1">
            <div class="portlet light bordered">
                ...
                <div class="portlet-body form">
                    <form class="form-horizontal" role="form" action="{{ url('product/modifier-group/export-price') }}" method="post">
                        <div class="form-body">
        ...
        <div class="switcher-item" data-step="2">
            <div class="portlet light bordered">
                ...
                <div class="portlet-body form upload-container">
                    <div id="upload-form">
                        <form class="form-horizontal" role="form" action="{{ url('product/modifier-group/import-price/save') }}" method="post" enctype="multipart/form-data" id="form-upload">
                            <div class="form-body">
                                <div class="form-group text-center">
