            ...
            <form class="form-horizontal" id="form_product_modifier_group" role="form" action="{{ url('product/modifier-group/update') }}/{{$result['id_product_modifier_group']}}" method="post" enctype="multipart/form-data">
                <div class="form-body">
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <div class="input-icon right">
                                <input type="text" placeholder="Product Modifier Group Name" class="form-control" name="text" value="{{ $result['product_modifier_group_name'] }}" required>
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group" id="div_list_product">
                        ...
                        <div class="col-md-6">
                            <select  class="form-control select2" name="id_product[]" multiple id="select_product" @if($assign !='Product') disabled @endif>
