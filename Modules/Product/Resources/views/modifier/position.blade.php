...
@section('page-script')
    ...
    <script type="text/javascript">
        ...
        function sortProductModifier(e) {
            ...
            var data = {_token: token, modifier_ids: ids};

            $.ajax({
                type : "POST",
                url : "{{ url('product/modifier/position/assign') }}",
                data : data,
...
@section('content')
    ...
    <div class="portlet light bordered">
        <div class="portlet-title">
            <div class="caption">
                <span class="caption-subject sbold uppercase font-blue">List Modifier By Position</span>
            </div>
        </div>
                    ...
                    <div class="tab-content">
                        <ul class="nav sortable-product">
                            @foreach($list as $value)
                                <li class="product-li" data-id="{{$value['id_product_modifier']}}">
