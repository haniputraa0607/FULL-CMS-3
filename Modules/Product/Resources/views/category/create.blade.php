                ...
                <div class="form-body">
                    <div class="form-group">
                        ...
                        <div class="col-md-7">
                            <div class="input-icon right">
                                <input type="text" placeholder="Category Name" class="form-control" name="product_category_name" value="{{ old('product_category_name') }}">
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-7">
                            <div class="input-icon right">
                                <i class="fa fa-question-circle tooltips" data-original-title="Deskripsi Kategori Produk" data-container="body"></i>
                                <textarea name="product_category_description" class="form-control summernote">{{ old('product_category_description') }}</textarea>
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
