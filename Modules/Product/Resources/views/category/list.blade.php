...
@section('page-style')
    ...
    <link href="{{Cdn::asset('kopikenangan-view-asset/public/css/custom.css') }}" rel="stylesheet" type="text/css" />
@endsection
...
@section('page-script')
    ...
    <script src="{{Cdn::asset('kopikenangan-view-asset/public/assets/pages/scripts/table-datatables-responsive.min.js') }}" type="text/javascript"></script>
