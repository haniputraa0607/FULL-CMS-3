		...
		<div class="mt-element-step">
			<div class="row step-line">
				<div class="col-md-4 mt-step-col first active" data-step="1">
					...
					<div class="mt-step-title uppercase font-grey-cascade">Download Template Plastic Status</div>
					<div class="mt-step-content font-grey-cascade">Download current plastic status</div>
				</div>
				<div class="col-md-4 mt-step-col" data-step="2">
					<div class="mt-step-number bg-white">2</div>
					<div class="mt-step-title uppercase font-grey-cascade">Upload Data Plastic Status</div>
					<div class="mt-step-content font-grey-cascade">Import from modifie plastic status list</div>
				</div>
				<div class="col-md-4 mt-step-col last" data-step="3">
					<div class="mt-step-number bg-white">#</div>
					<div class="mt-step-title uppercase font-grey-cascade">Result Plastic Status</div>
					<div class="mt-step-content font-grey-cascade">Report imported plastic status</div>
				</div>
			</div>
		</div>
	</div>
...
<div class="switcher" data-current-step="-1">
		...
		<div class="portlet light bordered">
			...
			<div class="portlet-body form">
				<div class="m-heading-1 border-green m-bordered">
					<p style="white-space: pre-wrap;">Menu ini digunakan untuk melakukan impor atau ekspor status plastic pada setiap outlet.</p>
					<p style="white-space: pre-wrap;">Outlet diidentifikasi berdasarkan <b>outlet code</b>. Apabila outlet code tidak tersedia maka data tersebut akan <b>diabaikan</b>.</p>
					<br>
	...
	<div class="switcher-item" data-step="1">
		<div class="portlet light bordered">
			...
			<div class="portlet-body form">
				<form class="form-horizontal" role="form" action="{{ url('product-plastic/export-plastic-status-outlet') }}" method="post">
					<div class="form-body">
	...
	<div class="switcher-item" data-step="2">
		<div class="portlet light bordered">
			...
			<div class="portlet-body form upload-container">
				<div id="upload-form">
					<form class="form-horizontal" role="form" action="{{ url('product-plastic/import-plastic-status-outlet/save') }}" method="post" enctype="multipart/form-data" id="form-upload">
						<div class="form-body">
							<div class="form-group text-center">
