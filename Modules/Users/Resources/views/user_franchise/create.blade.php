...
@section('content')
    ...
    <div class="portlet light bordered">
        ...
        <div class="portlet-body form">
            <form class="form-horizontal" role="form" action="{{url('user/user-franchise/store')}}" method="post" enctype="multipart/form-data">
                <div class="form-body">
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <input class="form-control" type="text" id="input-username" name="username" value="{{old('username')}}" required placeholder="Enter username here"/>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <input class="form-control" type="text" name="email" value="{{old('email')}}" id="input-email" required placeholder="Enter email here"/>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <input class="form-control" type="text" name="name" value="{{old('name')}}" required placeholder="Enter name here"/>
                        </div>
                    </div>
                    <div class="form-group" id="select_outlet" @if(old('level') == 'Super Admin') style="display: none" @endif>
                        ...
                        <div class="col-md-4">
                            <select class="form-control select2" name="id_outlet" id="select-brand" required>
                                ...
                                @foreach($outlets as $val)
                                    <option value="{{$val['id_outlet']}}" @if(old('id_outlet') == $val['id_outlet']) selected @endif>{{$val['outlet_code']}} - {{$val['outlet_name']}}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <input data-switch="true" type="checkbox" name="user_franchise_status" data-on-text="Active" data-off-text="Inactive" {{old('user_franchise_status') ==  'Active' || empty(old('user_franchise_status'))? 'checked' : ''}}/>
                        </div>
                    </div>
                    <div class="form-group">
