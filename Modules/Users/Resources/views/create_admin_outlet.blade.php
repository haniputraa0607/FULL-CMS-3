...
@section('page-style')
	...
	<link href="{{ env('AWS_ASSET_URL') }}{{('assets/global/plugins/typeahead/typeahead.css?x=1') }}" rel="stylesheet" type="text/css" /> 
...
@section('page-script')
	...
	<script src="{{ env('AWS_ASSET_URL') }}{{('assets/pages/scripts/components-typeahead.min.js') }}" type="text/javascript"></script>
