...
@section('page-style')
	...
	<link href="{{ url('assets/global/plugins/typeahead/typeahead.css?x=1') }}" rel="stylesheet" type="text/css" /> 
...
@section('page-script')
	...
	<script src="{{ url('assets/pages/scripts/components-typeahead.min.js') }}" type="text/javascript"></script>
