...
@section('page-style')
	...
	<link href="{{Cdn::asset('kk-ass/assets/global/plugins/typeahead/typeahead.css?x=1') }}" rel="stylesheet" type="text/css" /> 
...
@section('page-script')
	...
	<script src="{{Cdn::asset('kk-ass/assets/pages/scripts/components-typeahead.min.js') }}" type="text/javascript"></script>
