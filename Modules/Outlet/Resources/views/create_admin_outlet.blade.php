		...
		<div class="portlet light bordered">
			<div class="portlet-title">
				<div class="caption font-blue ">
					...
					<span class="caption-subject bold uppercase">Create New Admin Outlet</span>
				</div>
			</div>
					...
					<div class="form-body">
						...
						<div id="newUser">
							<div class="form-group">
								...
								<div class="col-md-9">
									<input type="text" id="fieldName" name="name" placeholder="User Name (Required)" class="form-control fieldNewUser" value="{{old('name')}}" required/> 
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-md-9">
									<input type="text" name="phone" placeholder="Phone Number (Required & Unique)" class="form-control fieldNewUser" value="{{old('phone')}}" required/>
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-md-9">
									<input type="email" name="email" placeholder="Email (Required & Unique)" class="form-control fieldNewUser" value="{{old('email')}}" required/>
								</div>
							</div>
						</div>
