<script>
    ...
    function changeSubject(val){
        ...
        if(subject_value == 'user_status'){
            var operator = "conditions["+index+"][operator]";
            var operator_value = document.getElementsByName(operator)[0];
            for(i = operator_value.options.length - 1 ; i >= 0 ; i--) operator_value.remove(i);
            operator_value.options[operator_value.options.length] = new Option('Franchise', 'Franchise');
            operator_value.options[operator_value.options.length] = new Option('Not Franchise', 'Not Franchise');
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <div class="col-md-4">
                                                <select name="subject" class="form-control input-sm select2" placeholder="Search Subject" onChange="changeSubject(this.name)" style="width:100%">
                                                    ...
                                                    <option value="user_status" @if ($con['subject'] == 'user_status') selected @endif>User Status</option>
                                                </select>
                                            </div>
                                            <div class="col-md-4">
