...
<div class="row" style="margin-top:20px">
	<form role="form" action="" method="POST" class="form-horizontal">
		<div class="col-md-12">
			{{ csrf_field() }}
			@if(isset($result['inbox_global_rule_parents']))
				<?php
					$search_param = $result['inbox_global_rule_parents'];
				...
				<div class="portlet-body form">
					<div class="form-body">
						...
						<div class="form-group">
							...
							<div class="col-md-10">
								<select name="inbox_global_clickto" id="inbox_global_clickto" class="form-control select2" onChange="fetchDetail(this.value, 'inbox')" required>
									...
									<option value="Logout" @if(old('inbox_global_clickto') == 'Logout') selected @endif>Logout</option>
								</select>
							</div>
						</div>
						...
						<div class="form-group" id="div_inbox_content" style="display:none">
							...
							<div class="col-md-10">
								<textarea name="inbox_global_content" id="inbox_global_content" class="form-control summernote">@if(old('inbox_global_content')) <?php echo old('inbox_global_content'); ?> @endif</textarea>
								You can use this variables to display user personalized information:
								<br><br>
								<div class="row">
									@foreach($textreplaces as $key=>$row)
