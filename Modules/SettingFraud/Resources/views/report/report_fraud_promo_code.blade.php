                    ...
                    <tr>
                        ...
                        <td>
                            <div class="form-group row">
                                ...
                                <div class="col-md-12"><input class="form-control" disabled value="(below) {{$value['fraud_setting_parameter_detail']}} minutes"></div>
                            </div>
                            <div class="form-group row">
                            ...
                            @if($value['fraud_setting_auto_suspend_status'] == 1 )
                                <div class="form-group row">
                                    <label class="col-md-12">Number of violations</label>
