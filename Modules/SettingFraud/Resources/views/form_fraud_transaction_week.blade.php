...
<div class="portlet box green">
    <div class="portlet-title">
        <div class="caption">
            <i class="fa fa-gear"></i>Fraud Detection Transaction Week</div>
        <div class="tools">
            <a href="javascript:;" class="collapse"> </a>
        </div>
    </div>
    <div class="portlet-body">
        <p>Setting Fraud Detection transaction week adalah mengatur maksimal jumlah transaksi yang diperbolehkan  dalam 1 minggu untuk semua user.</p>
