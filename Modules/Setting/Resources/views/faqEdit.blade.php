...
@section('page-script')
    <script src="{{Cdn::asset('kopikenangan-view-asset/public/assets/datemultiselect/jquery-ui.multidatespicker.js') }}" type="text/javascript"></script>
...
@section('content')
    ...
    <div class="portlet light bordered">
        ...
        <div class="portlet-body form">
            <form class="form-horizontal form-bordered" action="{{ url('setting/faq/update', $faq['id_faq']) }}" method="post">
                <div class="form-body">
