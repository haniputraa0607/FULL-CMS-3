									...
									<div class="col-md-9">
										<div class="fileinput fileinput-new" data-provides="fileinput">
											<div class="fileinput-new thumbnail" style="width: 300px; height: 180px;">
												<img src="{{env('APP_API_URL')}}assets/pages/img/noimg-500-375.png" alt="">
											</div>
								...
								<div class="tab-pane fade active in" id="tab_1_1">
									@foreach($data['background'] as $row)
										...
										<div class="col-md-3 ui-state-default" id="photo-{{$row['id_home_background']}}" style="text-align:center;padding: 20px;margin-top:20px;background-color: #dedede;margin-right:30px" draggable="true">
											<img src="{{env('APP_API_URL')}}{{$row['picture']}}" alt="Category Image" width="150">
											<br><br>
											<a href="{{env('APP_API_URL')}}{{$row['picture']}}" class="cbp-lightbox cbp-l-caption-buttonRight btn blue uppercase btn blue uppercase" style="font-size: 14px;padding: 6px;">View</a>
