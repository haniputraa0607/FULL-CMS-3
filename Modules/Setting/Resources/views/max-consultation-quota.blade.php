            ...
            <div class="form-body">
                <div class="form-group">
                    <div class="input-icon right">
                            @if($menu_active == 'max-consultation-quota')
                                @php $type = 'max_consultation_quota'; @endphp
                            @else
                            ...
                            <span class="required" aria-required="true"> * </span>
                                <i class="fa fa-question-circle tooltips" data-original-title="Kuota maksimal dari setiap sesi konsultasi" data-container="body"></i>
                            </label>
                        </div>
                        <div class="col-md-8">
                            <div class="repeat">
                                ...
                                @if(isset($result) && is_array($result))
                                    ...
                                    <div data-repeater-item class="row" style="padding-bottom:20px;">
                                        ...
                                        <div class="col-md-4">
                                            <input type="text" class="form-control" placeholder="quota maximum" name="value" value="{{$data['value']}}"/>
                                        </div>
                                        <br>
                                    </div>
                                    @endforeach
