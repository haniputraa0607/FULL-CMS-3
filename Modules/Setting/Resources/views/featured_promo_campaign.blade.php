					 			...
					 			<div class="portlet portlet-sortable light bordered col-md-3">
					 				<div class="portlet-title">
					 			 	...
					 			 	<div class="click-to text-center">
					 			 		<div>@if(strlen($featured_promo['promo_campaign']['promo_title']) > 18) {{ substr($featured_promo['promo_campaign']['promo_title'], 0, 19) }} ... @else {{ $featured_promo['promo_campaign']['promo_title'] }} @endif</div>
